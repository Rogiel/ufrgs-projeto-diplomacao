...
As Tabelas \ref{tab:resultados-comparacao-win-rate} e \ref{tab:resultados-comparacao-survive} apresentaram as taxas de vitória e de sobrevivência de cada \textit{\gls{build-order}}\todo{continuar}
